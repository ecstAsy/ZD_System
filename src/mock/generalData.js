  ...
  'data|80-100':[
    {
      ...
      liStartDate:'@datetime("yyyy-MM-dd HH:mm:ss")',
      liEndDate:'@datetime("yyyy-MM-dd HH:mm:ss")',
      cliStartDate:'@datetime("yyyy-MM-dd HH:mm:ss")',
      cliEndDate:'@datetime("yyyy-MM-dd HH:mm:ss")',
      rebateType : '保单申请',
